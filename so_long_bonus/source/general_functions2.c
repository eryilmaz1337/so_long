...
t_img	*insertimgpath(void)
{
	...
	picture->imgfire1 = "./img/fire-32x32/fire1.xpm";
	picture->imgfire2 = "./img/fire-32x32/fire2.xpm";
	picture->imgfire3 = "./img/fire-32x32/fire3.xpm";
	picture->imgfire4 = "./img/fire-32x32/fire4.xpm";
